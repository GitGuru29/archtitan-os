...
airootfs_image_tool_options=('-comp' 'zstd' '-Xcompression-level' '19' '-b' '1M' '-mem' '4G' '-processors' '6')
bootstrap_tarball_compression=('zstd' '-c' '-T6' '--long' '-19')
file_permissions=(
  ["/etc/shadow"]="0:0:400"
  ["/etc/gshadow"]="0:0:400"
  ...
  ["/usr/local/bin/titan-bar-daemon"]="0:0:755"
  ["/usr/local/bin/titan-bar-media"]="0:0:755"
  ["/usr/local/bin/titan-bar-next"]="0:0:755"
  ["/usr/local/bin/titan-bar-prev"]="0:0:755"
  ["/usr/local/bin/titanbrowser"]="0:0:755"
  ["/usr/local/bin/titan-browser"]="0:0:755"
  ...
  ["/usr/local/bin/titan-hud-context"]="0:0:755"
  ["/usr/local/bin/titan-hud-gpu"]="0:0:755"
  ["/usr/local/bin/titan-powermenu"]="0:0:755"
